...
class Test extends FunSuite with BeforeAndAfter {
  ...
  runTests(fileDF("data/us-election-2012-results-by-county.csv"), tableDf("test_table", Map("driver" -> "org.postgresql.Driver", "user" -> "default", "password" -> "secret1", "url" -> "jdbc:postgresql://localhost:5432/pgdb")), "csvtopostgresconnector")
